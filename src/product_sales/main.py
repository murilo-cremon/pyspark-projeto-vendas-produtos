...
from processing.customer_dimension import save_parquet_csv_file_to_customer_dimension

spark = create_spark_session(APP_NAME)
# print(f'Funcionou: {spark}')

#ingestion_file_raw_zone(spark, LANDING_ZONE_FILE, RAW_ZONE)
save_parquet_csv_file_to_customer_dimension(spark, TRUSTED_ZONE, REFINED_ZONE)
